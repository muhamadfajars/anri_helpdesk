...
class _ProfilePageState extends State<ProfilePage> {
  ...
  // Fungsi ini sudah benar, mengambil data yang disimpan saat login dari database.
  ...
  // --- PERBAIKAN: Fungsi logout dengan dialog konfirmasi ---
  ...
  // --- PERBAIKAN: Fungsi untuk menampilkan dialog "Tentang Aplikasi" ---
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                // --- PERBAIKAN: Tombol Pengaturan bisa diklik ---
                ...
                // --- PERBAIKAN: Tombol Tentang Aplikasi bisa diklik ---
                _buildProfileMenuItem(
                ...
                // --- PERBAIKAN: Tombol Logout memanggil fungsi dengan konfirmasi ---
                _buildProfileMenuItem(
                  icon: Icons.logout,
                  title: 'Logout',

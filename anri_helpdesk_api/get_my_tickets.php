...
try {
    ...
    if ($current_user_id === 0) { throw new Exception("Gagal mengidentifikasi pengguna dari token."); }
    ...
    // --- PERBAIKAN: Standarisasi Mapping ID Prioritas ---
    ...
    if ($category_filter != 'All') {
        $conditions[] = "t.category = ?"; $params[] = (int)$category_filter; $types .= 'i';
    }
    ...
    $sql .= " ORDER BY (t.priority = 0) DESC, t.lastchange DESC LIMIT ? OFFSET ?";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // --- PERBAIKAN: Gunakan mapping terbalik yang konsisten ---
